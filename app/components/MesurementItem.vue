...
<template>
    <UCollapsible class="hover:bg-gray-50 rounded transition-colors">
        <div class="measurement-item p-2 " :class="{ 'cursor-pointer': details }">
            <div class="flex items-center justify-between">
                <span class="font-medium text-[var(--ui-text)]">{{ label }}</span>
                <div class="flex items-center gap-2">
                    <UIcon v-if="details" name="i-heroicons:question-mark-circle" class="size-5 bg-[var(--ui-primary)]" />
